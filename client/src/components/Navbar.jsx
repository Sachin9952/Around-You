            ...
            <div className="hidden md:flex flex-1 items-center justify-center gap-7">
              ...
              {providerCTA && (
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                  <Link
                    to={providerCTA.path}
                    className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-bold transition-all duration-200 ${providerCTA.style === 'filled'
            ...
            <div className="md:hidden flex items-center gap-2">
              {isAuthenticated ? (
                <button
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${isOpen ? 'bg-[#1A2B2A] text-white' : 'bg-white text-[#45B1A8] border border-gray-100 shadow-sm'
                    }`}
                >
                ...
                <button
                  ...
                  className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${isOpen ? 'bg-[#1A2B2A] text-white shadow-lg' : 'bg-white text-[#1A2B2A] border border-gray-100 shadow-sm'
                    }`}
                >
                    ...
                    {navLinks.map((link) => {
                      ...
                      return (
                        <Link
                          ...
                          to={link.path}
                          onClick={() => setIsOpen(false)}
                          className={`flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all border-l-4 active:scale-[0.97] ${isActive
                  ...
                  <section className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <Link
                        ...
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-4 px-4 py-3.5 rounded-xl border transition-all active:scale-[0.97] ${location.pathname === '/provider/dashboard'
                  ...
                  <section className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <Link
                        to="/dashboard"
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-4 px-4 py-3.5 rounded-xl border transition-all border-l-4 active:scale-[0.97] ${location.pathname === '/dashboard'
                      ...
                      <Link
                        to="/inbox"
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-4 px-4 py-3.5 rounded-xl border transition-all border-l-4 active:scale-[0.97] ${location.pathname === '/inbox'
                            ? 'bg-[#45B1A8]/20 text-[#45B1A8] border-[#45B1A8] shadow-sm shadow-[#45B1A8]/10'
                            : 'bg-white border-transparent border-l-transparent text-[#4A5568] hover:bg-gray-50'
                          }`}
                      >
                      ...
                      {user?.role !== 'admin' && (
                        <Link
                          to="/post-request"
                          onClick={() => setIsOpen(false)}
                          className={`flex items-center gap-4 px-4 py-3.5 rounded-xl border transition-all border-l-4 active:scale-[0.97] ${location.pathname === '/post-request'
                              ? 'bg-[#45B1A8]/20 text-[#45B1A8] border-[#45B1A8] shadow-sm shadow-[#45B1A8]/10'
                              : 'bg-white border-transparent border-l-transparent text-[#4A5568] hover:bg-gray-50'
                            }`}
                        >
